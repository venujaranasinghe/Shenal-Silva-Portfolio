...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden relative">
      ...
      <div className="fixed inset-0 bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-pink-900/20 via-transparent to-transparent" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span className="font-bold text-xl">ShenalSilva</span>
        ...
        <div className="max-w-7xl mx-auto w-full">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <h1 className="text-7xl lg:text-9xl font-black leading-tight mb-6">
                    <TypingAnimation
                      texts={["SHENAL", "DEVELOPER", "CREATOR", "INNOVATOR"]}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-20">
            <div className="text-center p-8 bg-gray-900/30 backdrop-blur-sm rounded-3xl border border-gray-800/50 hover:bg-gray-800/30 transition-all duration-300 group">
              ...
              <div className="text-gray-400 text-sm font-medium mt-2 group-hover:text-gray-300 transition-colors">
                PROJECTS COMPLETED
              </div>
            </div>
            <div className="text-center p-8 bg-gray-900/30 backdrop-blur-sm rounded-3xl border border-gray-800/50 hover:bg-gray-800/30 transition-all duration-300 group">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <Card className="bg-gray-900/50 border-gray-800 backdrop-blur-xl p-8 mt-8 hover:bg-gray-800/50 transition-all duration-300 group">
                  <div className="text-center">
                    ...
                    <p className="text-gray-400 text-sm">Creating experiences users love</p>
                  </div>
                </Card>
      ...
      <section id="services" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-6xl font-bold mb-6">My Quality Services</h2>
            <p className="text-gray-400 text-xl max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {services.map((service, index) => (
              <Card
                key={index}
                className="bg-gray-900/30 backdrop-blur-xl border-gray-800/50 hover:bg-gray-800/30 transition-all duration-500 group cursor-pointer overflow-hidden"
              >
      ...
      <section id="portfolio" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-6xl font-bold mb-6">My Recent Works</h2>
            <p className="text-gray-400 text-xl max-w-3xl mx-auto leading-relaxed">
            ...
            <div>
              ...
              <div className="space-y-8">
                {experience.map((exp, index) => (
                  <Card
                    key={index}
                    className="bg-gray-900/30 border-gray-800/50 backdrop-blur-xl hover:bg-gray-800/30 transition-all duration-300"
                  >
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-6xl font-bold mb-6">My Skills</h2>
            <p className="text-gray-400 text-xl max-w-3xl mx-auto leading-relaxed">
                  ...
                  <div className="text-center">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <span className="text-purple-400 font-semibold text-lg">{skill.level}%</span>
                      </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-6xl font-bold mb-6">My Client's Stories</h2>
            <p className="text-gray-400 text-xl max-w-3xl mx-auto leading-relaxed">
      ...
      {/* Enhanced Footer */}
      <footer className="border-t border-gray-800/50 py-16 px-4 sm:px-6 lg:px-8 bg-gray-900/20">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-2">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  <span className="font-bold text-2xl">ShenalSilva</span>
                  <span className="text-purple-400">.dev</span>
                </div>
              </div>
              <p className="text-gray-400 leading-relaxed mb-6 max-w-md">
                Passionate web developer and CS student creating digital experiences that matter. Always ready to take
                on new challenges and build something extraordinary.
              </p>
              <div className="flex space-x-4">
                <Button
                  variant="ghost"
                  size="icon"
                  className="w-12 h-12 hover:bg-gray-800/50 text-gray-400 hover:text-white transition-all duration-300 border border-gray-800 hover:border-purple-500"
                >
                  <Github className="w-6 h-6" />
                </Button>
                <Button
                  variant="ghost"
                  size="icon"
                  className="w-12 h-12 hover:bg-gray-800/50 text-gray-400 hover:text-white transition-all duration-300 border border-gray-800 hover:border-blue-500"
                >
                  <Linkedin className="w-6 h-6" />
                </Button>
                <Button
                  variant="ghost"
                  size="icon"
                  className="w-12 h-12 hover:bg-gray-800/50 text-gray-400 hover:text-white transition-all duration-300 border border-gray-800 hover:border-cyan-500"
                >
                  <Twitter className="w-6 h-6" />
                </Button>
                <Button
                  variant="ghost"
                  size="icon"
                  className="w-12 h-12 hover:bg-gray-800/50 text-gray-400 hover:text-white transition-all duration-300 border border-gray-800 hover:border-pink-500"
                >
            ...
            <div>
              ...
              <div className="space-y-3">
                <a
                  href="#home"
                  className="block text-gray-400 hover:text-white transition-colors hover:translate-x-1 duration-300"
                >
                  Home
                </a>
                <a
            ...
            <div>
              ...
              <div className="space-y-3">
                <p className="text-gray-400 hover:text-white transition-colors cursor-pointer">Frontend Development</p>
                <p className="text-gray-400 hover:text-white transition-colors cursor-pointer">Backend Development</p>
                <p className="text-gray-400 hover:text-white transition-colors cursor-pointer">
                  Full Stack Development
                </p>
                <p className="text-gray-400 hover:text-white transition-colors cursor-pointer">Mobile Development</p>
                <p className="text-gray-400 hover:text-white transition-colors cursor-pointer">UI/UX Design</p>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-gray-800/50 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <p className="text-gray-500 text-center md:text-left">
                © 2024 Shenal Silva. All rights reserved. Made with ❤️ in Sri Lanka
              </p>
